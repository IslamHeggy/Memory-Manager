...
void initialize_paging()
{
	...
	curr_number_of_blocks=0;
	blocks_info[curr_number_of_blocks].start_va=KERNEL_HEAP_START+0x4000;
	blocks_info[curr_number_of_blocks].size=KERNEL_HEAP_MAX-(KERNEL_HEAP_START+0x4000)+1;
	LIST_INSERT_HEAD(&Block_info_free_list,&blocks_info[curr_number_of_blocks]);
