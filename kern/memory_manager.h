...
#define Max_number_of_blocks 1000000
...
// manage the kheap memory
extern struct Block_Info blocks_info[];
extern struct Linked_List_block Block_info_taken_list;
extern struct Linked_List_block Block_info_free_list;
extern struct Linked_List_block free_blocks;
...
static inline struct Frame_Info* to_frame_info(uint32 physical_address)
{
	if (PPN(physical_address) >= number_of_frames)
		panic("to_frame_info called with invalid pa=%x\n",physical_address);
